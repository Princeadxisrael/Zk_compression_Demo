 ...
 */
declare function deriveAddressSeedLegacy(
    seeds: Uint8Array[],
    programId: PublicKey,
): Uint8Array;
/**
 ...
 */
declare function deriveAddressLegacy(
    seed: Uint8Array,
 ...
 * Use this when you explicitly want V2 derivation (e.g., in tests).
 */
declare function deriveAddressV2(
...
declare function hashvToBn254FieldSizeBeU8Array(
    bytes: Uint8Array[],
): Uint8Array;
/**
...
declare function convertInvokeCpiWithReadOnlyToInvoke(
    data: any,
 ...
 */
declare function getLightSystemAccountMetasLegacy(
    config: SystemAccountMetaConfig,
): AccountMeta[];
/**
 * Get Light system account metas. Auto-selects V1 or V2 layout based on featureFlags.
 */
declare function getLightSystemAccountMetas(
    config: SystemAccountMetaConfig,
): AccountMeta[];
declare function getLightSystemAccountMetasV2(
    config: SystemAccountMetaConfig,
): AccountMeta[];
...
declare const validateNumbersForProof: (
    hashesLength: number,
    newAddressesLength: number,
) => void;
declare const validateNumbersForInclusionProof: (hashesLength: number) => void;
declare const validateNumbersForNonInclusionProof: (
    newAddressesLength: number,
) => void;
declare const validateNumbers: (
    length: number,
...
declare const lightSystemProgram =
...
declare const LIGHT_TOKEN_PROGRAM_ID: PublicKey;
 ...
 */
declare function getStateTreeInfoByPubkey(
    treeInfos: TreeInfo[],
    treeOrQueue: PublicKey,
): TreeInfo;
declare function getTreeInfoByPubkey(
    treeInfos: TreeInfo[],
    treeOrQueue: PublicKey,
): TreeInfo;
/**
 ...
 */
declare function selectStateTreeInfo(
    infos: TreeInfo[],
    treeType?: TreeType,
 ...
 */
declare function getAllStateTreeInfos({
    connection,
    stateTreeLUTPairs,
}: {
    connection: Connection;
 ...
 */
declare function packDecompressAccountsIdempotent(
    programId: PublicKey,
    proof: {
 ...
 * @deprecated use {@link CompressedAccount} instead
 */
type CompressedAccountWithMerkleContextLegacy = CompressedAccount &
    MerkleContext;
/**
 ...
 * Client-side only.
 */
declare const createCompressedAccountMeta: (
    treeInfo: PackedStateTreeInfo,
    outputStateTreeIndex: number,
    address?: number[],
    lamports?: BN,
 ...
 */
declare const createCompressedAccountLegacy: (
    owner: PublicKey,
    lamports?: BN,
 ...
 * @deprecated.
 */
declare const createCompressedAccountWithMerkleContextLegacy: (
 ...
 * @deprecated use {@link createCompressedAccountMeta} instead.
 */
declare const createMerkleContextLegacy: (
    treeInfo: TreeInfo,
    hash: BN254,
    leafIndex: number,
    proveByIndex?: boolean,
 ...
 */
declare function mergeSignatures(
...
declare function decodeInstructionDataInvokeCpiWithReadOnly(
    buffer: Buffer$1,
): unknown;
 ...
 */
declare function packTreeInfos(
    remainingAccounts: PublicKey[],
...
export {
    ...
    ALICE,
    type AccountDataWithTreeInfo,
    type AccountProofInput,
    AccountProofResult,
    type ActiveTreeBundle,
    type AddressTreeInfo,
    type AddressWithTree,
    type AddressWithTreeInfo,
    type AddressWithTreeInfoV2,
    ...
    CompressedTokenAccountResultV2,
    ...
    LightSystemProgram,
    type LightSystemProgram$1 as LightSystemProgramIDL,
    type LightWasm,
    LookupTableError,
    ...
    type SignaturesForAddressInterfaceResult,
    SlotResult,
    type StateTreeInfo,
    type StateTreeLUTPair,
    SystemAccountMetaConfig,
